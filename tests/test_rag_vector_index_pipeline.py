...
"""
    ...
    def test_rag_chain_real_inference(self, rag_chain):
        ...
        matches = sum(1 for topic in expected_topics if topic.lower() in response.lower())
        assert matches > 0, "Response should contain at least one known optimization technique"
