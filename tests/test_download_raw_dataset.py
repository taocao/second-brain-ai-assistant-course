...
from second_brain.entities.page import Page, PageMetadata
...
class TestDownloadRawDatasetIntegration:
    ...
    def test_config_parameters(self, config):
        ...
        assert 'extract_collection_name' in parameters, "Missing extract_collection_name parameter"
        assert 'limit' in parameters, "Missing limit parameter"
        assert isinstance(parameters['limit'], int), "Limit parameter should be an integer"
    ...
    def test_document_structure(self, mongodb_service, collection_name):
        ...
        assert isinstance(metadata['properties'], dict), "Metadata properties should be dict"
    ...
    def test_document_content_validity(self, mongodb_service, collection_name):
        ...
        assert len(page.metadata.title.strip()) > 0, "Metadata title should not be empty"
